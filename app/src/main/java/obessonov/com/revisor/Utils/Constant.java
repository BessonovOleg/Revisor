package obessonov.com.revisor.Utils;

public class Constant {
    public static final String CAPTION_DIGITAL_INPUT      = "caption_digital_input";
    public static final String RESULT_DIGITAL_INPUT       = "result_digital_input";
